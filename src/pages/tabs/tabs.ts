...
export class TabsPage {
  ...
  public fixedURL: string = 'http://tcc.1click.pf/museum/index.php?mat=42ZENOI09G&oeuvre=';
  private scannedData: any;

  result: BarcodeScanResult;
  constructor(public dbService: HomePage, private bcs: BarcodeScanner, private toastCtrl: ToastController, public iab: InAppBrowser) {
...
/*   scanBarcode(){
  ...
  private updateSeenStatus(): any {
    this.dbService.db.executeSql('UPDATE `oeuvre` SET oeuvre.checked = "1" WHERE oeuvre.qrcode='+this.scannedData+ ';', {})
      .then(() => {
...
const options: InAppBrowserOptions = {
  zoom: 'no'
    ...
    this.iab.create(this.fixedURL + this.scannedData, '_self', options);
  }
